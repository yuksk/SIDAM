...
Static Function pnl(
	...
	ModifyControlList "z1V;z2V;binsV" bodyWidth=120, proc=KMHistogram#pnlSetVar, valueColor=(KM_CLR_EVAL_R,KM_CLR_EVAL_G,KM_CLR_EVAL_B), fColor=(KM_CLR_EVAL_R,KM_CLR_EVAL_G,KM_CLR_EVAL_B), win=$pnlName
