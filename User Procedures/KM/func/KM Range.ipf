...
Static Function pnl(String grfName)
	...
	ModifyGraph/W=$subGrfName rgb($ks_name)=(KM_CLR_LINE_R, KM_CLR_LINE_G, KM_CLR_LINE_B)
	ModifyGraph/W=$subGrfName axRGB=(KM_CLR_LINE_R, KM_CLR_LINE_G, KM_CLR_LINE_B), tlblRGB=(KM_CLR_LINE_R, KM_CLR_LINE_G, KM_CLR_LINE_B), alblRGB=(KM_CLR_LINE_R, KM_CLR_LINE_G, KM_CLR_LINE_B)
	ModifyGraph/W=$subGrfName gbRGB=(KM_CLR_BG_R, KM_CLR_BG_G, KM_CLR_BG_B), wbRGB=(KM_CLR_BG_R, KM_CLR_BG_G, KM_CLR_BG_B)
